...
public class DateUtils {
    ...
    /**
     * 根据格式解析字符串时间
     * @param dateStr   “1900-01-01”
     * @param partten   “yyyy/MM/dd”
     * @return
     */
    public static Date getOneDay(String dateStr,String partten){
        String p = StringUtils.isBlank(partten) ? "yyyy-MM-dd" : partten;
